# -*- coding: utf-8 -*-
"""GlowTTS - Train example Thorsten-DE.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZGBQHTvwnBUg6ZBPrnROnwtN7lfIXlN8
"""
...
if __name__ == '__main__':
    ...
    output_path = os.path.abspath("./train")
    ...
    dataset_config = BaseDatasetConfig(
        formatter="ljspeech", meta_file_train="metadata_train.csv", path=os.path.join(os.path.abspath("./"), "ThorstenVoice-Dataset_2022.10/")
    )
